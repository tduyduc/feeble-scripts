...
// When this function is implemented in a spreadsheet's script editor, it can be invoked by simply typing the function in a cell.
// Example: GENERATECSV('First', 'Last', 'someone@domain.com', 'password', '/', 'False')
 ...
 * @param {string} org Organization unit path (/orgname).
 * @param {string} changepwd Change password at next sign-in (True or False).
 * @return {string} The CSV output, or the CSV header if no parameters are specified.
 * @customfunction
 */
